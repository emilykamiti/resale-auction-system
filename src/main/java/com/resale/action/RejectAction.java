...
public class RejectAction extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        email.setSubject("Bid Rejection");
        email.setBody("Your bid has been rejected." + "");
        ...
        try {
            ...
            System.out.println("{\"status\":\"success\", \"message\":\"Rejection email sent\"}");
        } catch (MessagingException e) {
            e.printStackTrace();
            response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            System.out.println("{\"status\":\"error\", \"message\":\"Failed to send rejection email\"}");
        }
    }
}
